...
/**
 * A converter that converts a Jwt object into a collection of GrantedAuthority objects representing the roles.
 */
public class KCRoleConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public Collection<GrantedAuthority> convert(Jwt jwt) {
        ...
        GrantedAuthority grantedAuthority = new SimpleGrantedAuthority("ttdtd");
